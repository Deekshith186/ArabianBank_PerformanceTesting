# 1 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_statements_e2e_v1\\\\combined_AB_Statements_e2e_v1.c"
...
# 1 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_statements_e2e_v1\\\\combined_AB_Statements_e2e_v1.c" 2
...
# 2 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_statements_e2e_v1\\\\combined_AB_Statements_e2e_v1.c" 2
...
# 3 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_statements_e2e_v1\\\\combined_AB_Statements_e2e_v1.c" 2
...
# 4 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_statements_e2e_v1\\\\combined_AB_Statements_e2e_v1.c" 2
...
Action()
{
	...
	lr_end_transaction("AB_Statements_T01_Launch",2);
	...
	lr_end_transaction("AB_Statements_T02_AccessPersonalBanking",2);
	...
	lr_end_transaction("AB_Statements_T03_UserLogin",2);
	...
	lr_end_transaction("AB_Statements_T04_SelectAccount",2);
	...
	lr_end_transaction("AB_Statements_T05_SelectStatements",2);
	...
	lr_end_transaction("AB_Statements_T06_SelectDetailedStatements",2);
    ...
    lr_save_datetime("%d", 0, "EDAY");
    lr_save_datetime("%m", 0, "EMON");
    lr_save_datetime("%Y", 0, "EYEAR");

     
     

    lr_save_datetime("%d", 0 - 15552000, "BDAY");
    lr_save_datetime("%m", 0 - 15552000, "BMON");
    lr_save_datetime("%Y", 0 - 15552000, "BYEAR");
	...
	lr_end_transaction("AB_Statements_T07_Choose_dates",2);
	...
	lr_end_transaction("AB_Statements_T08_UserLogout",2);

	return 0;
}
# 5 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_statements_e2e_v1\\\\combined_AB_Statements_e2e_v1.c" 2
...
# 6 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_statements_e2e_v1\\\\combined_AB_Statements_e2e_v1.c" 2
