# 1 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_account_summary_e2e_v1\\\\combined_AB_Account_Summary_e2e_v1.c"
...
# 1 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_account_summary_e2e_v1\\\\combined_AB_Account_Summary_e2e_v1.c" 2
...
# 2 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_account_summary_e2e_v1\\\\combined_AB_Account_Summary_e2e_v1.c" 2
...
# 3 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_account_summary_e2e_v1\\\\combined_AB_Account_Summary_e2e_v1.c" 2
...
vuser_init()
{
  lr_start_transaction("AB_AccountSummary_T01_Launch");
   ...
   web_reg_find("Text=Welcome To LoanIQ", "Fail=NotFound", 
	...
	lr_end_transaction("AB_AccountSummary_T01_Launch", 2);
	...
	lr_end_transaction("AB_AccountSummary_T02_AccessPersonalBanking",2);
	...
	lr_end_transaction("AB_AccountSummary_T03_UserLogin",2);
    
	lr_think_time(5);
	
	return 0;
}
# 4 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_account_summary_e2e_v1\\\\combined_AB_Account_Summary_e2e_v1.c" 2
...
Action()
{
	...
	lr_end_transaction("AB_AccountSummary_T04_SelectAccount",2);
...
fclose(fp); 
	...
	lr_end_transaction("AB_AccountSummary_T05_ViewAccountSummary",2);
...
# 5 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_account_summary_e2e_v1\\\\combined_AB_Account_Summary_e2e_v1.c" 2
...
vuser_end()
{
	...
	lr_end_transaction("AB_AccountSummary_T06_UserLogout",2);
	
	return 0;
}
# 6 "d:\\offline\\arabian_bank\\loadrunner\\scripts\\final scripts\\ab_account_summary_e2e_v1\\\\combined_AB_Account_Summary_e2e_v1.c" 2
